      ...
      <React.Fragment>
        <ScrollView>
          <View style={{ backgroundColor: '#ffebee', padding: 16 }}>
            ...
            />
            <Text>Jumlah orang: {this.state.jumlahOrang}</Text>
            <Text>
              Estimasi pengerjaan:{' '}
              {this.state.jumlahOrang * parseInt(item.lamaPengerjaan)}
            </Text>
            <Text>
              Total harga: {this.state.jumlahOrang * parseInt(item.harga)}
            </Text>
          </View>
          <View style={styles.root}>
            ...
            <View style={styles.fieldWrapper}>
              ...
              <TextInput
                style={styles.field}
                multiline
                onChangeText={this.handleChangeInput('alamat')}
              />
            </View>
            <View style={styles.fieldWrapper}>
